...
function TermsOfUse() {
  ...
  <div className="terms-of-use">
        ...
        <section className="copyright-section">
            ...
            <p>
                 © DevAsk 2022 © DevAsk Press and contributors 2022. <br /><br />

                Except as permitted by the copyright law applicable to you, you may not reproduce or communicate any of the content on this website, including files downloadable from this website, without the permission of the copyright owner. <br /><br />

                This Copyright Act allows certain uses of content from the internet without the copyright owner&apos;s permission. This includes uses by educational institutions and State governments, provided fair compensation is paid.<br /><br />

                The owners of copyright in the content on this website may receive compensation for the use of their content by educational institutions and governments, including from licensing schemes managed by the Copyright Agency.<br /><br />
