        ...
        {innerWidth < 600 ? (
            ...
            <div>
                ...
                <div className={styles.textWrapper}>
                    <p className={styles.text}>We are building a company focused on team growth as well as looking after the happiness and satisfaction of our dear customers.</p>
                    <p className={styles.text}>Customer Centric- We are customer focused and we keep evolving to meet the daily needs of our customers.</p>
                    <p className={styles.text}>Diversity and Inclusion - We are building a work environment that is inclusive of people of all backgrounds.</p>
                </div>
