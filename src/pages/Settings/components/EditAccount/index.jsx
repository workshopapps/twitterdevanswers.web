      ...
      <div className={EditAccountCSS.userinfo}>
        ...
        <div className='user-details-form'>
          <form>
            <label >
              Full name
              <input id='nameinput' className='textinput' type="text" value="Ayoola Faisal"  
 />
            </label>

            <label >
              Email address
              <input id='emailinput' className='textinput' type="email" value="ayoolafaisal@gmail.com"  />
            </label>
