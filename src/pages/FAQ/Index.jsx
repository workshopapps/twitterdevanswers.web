...
import web from '../../assets/faq-images/web.png';
import email from '../../assets/faq-images/email.png';
import folder from '../../assets/faq-images/folder.png';
import search from '../../assets/faq-images/searchnormal.png';
import arrowleft from '../../assets/faq-images/arrowleft.png';
import arrowdown from '../../assets/faq-images/Vector@2x.png';
import './Style.css';
			...
			<div className="container section__container">
				<div className="section__text_upper">
					...
					<div className="section__img_socials">
						<div className="section__img_icons">
							<img src={web} alt="web" />{' '}
							<span className="icon__text">Go to our website</span>
						</div>

						<div className="section__img_icons">
							<img src={email} alt="folder" />{' '}
							<span className="icon__text">Terms of Service</span>
						</div>
						<div className="section__img_icons">
				...
				<div className="accordion__sections_main">
					...
					{showItems && (
						<>
							<Accordion
								label="How to check my token balance?"
								open={isOpen2}
								setopen={setIsOpen2}
								height={setHeight}
								setheight={setHeightActive}
							...
							<Accordion
								label="Where should I paste my wallet?"
								open={isOpen3}
								setopen={setIsOpen3}
								height={setHeight}
								setheight={setHeightActive}
