...
import EditAccountCSS from './style.module.css';
import TestImage from '../../assets/settings-image/test-img.jfif';
		...
		<div className={EditAccountCSS.editaccount}>
			...
			<div className={EditAccountCSS.userinfo}>
				...
				<div className="user-details-form">
					<form className={EditAccountCSS.form}>
						<label className={EditAccountCSS.label}>
							Full name
							<input
								id="nameinput"
						...
						<label className={EditAccountCSS.label} htmlFor="phoneinput">
							Phone number
							<div className={EditAccountCSS.phonenumber}>
							<select value={status}  className={EditAccountCSS.flagimage}/>
								
								<input id='phoneinput' value="+234 8184017753" type='tel' className={EditAccountCSS.phoneinput}/>
						...
						<label className={EditAccountCSS.label}>
							Location
							<select
								className={EditAccountCSS.formcontrol}
								value={status}
